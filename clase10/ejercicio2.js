...
Escribe un programa que pida al usuario que ingrese su nombre, su edad y su peso, y luego muestre un mensaje personalizado 
...
console.log (`Tu nombre es ${nombre}, tu edad es ${edad} y tu peso es ${peso}`);